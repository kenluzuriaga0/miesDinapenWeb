<?php
    ...
    class Personas{
        ...
        $parroquia,$etnia,$estadoCivil,$GrupoEtario, $canton, $provincia,$discapacidad,$nivelDiscapacidad, $Barrio, $ApellidoFamiliar, $NombreFamiliar,$ParentezcoNNA, $CedulaFamiliar, $NumFamiliar, $PasaporteFamiliar) {
            $db = new Connection();
            $query = "INSERT INTO ListaIDPersonas (Apellido1,Apellido2,Nombre1,Nombre2,Cedula,FechaNacim,IDGenero,
            NacIDNacionalidad,NacIDParroquia, NacIDCanton,NacIDProvincia,IDEtnia,IDEstadoCivil,GrupoEtario,IDDiscapacidad,DiscapacidadNivel, Barrio, ApellidoFamiliar, NombreFamiliar, ParentezcoNNA, CedulaFamiliar, NumFamiliar, PasaporteFamiliar)
