<?php
    ...
    if($datos != NULL) {
        ...
        $datos->NumHijos,$datos->IDViveCon,$datos->IDCircunstancia,$datos->IDCondicion,$datos->DireccionCallePrincial,$datos->DireccionIntervencion,$datos->DiasLaborales,$datos->HorasLaborales,$datos->TiempoLaboral
